...
def history():
    """
    displays the users message history
    :return: none
    """
    if NAME_KEY not in session:
...
'''
@view.route("/GitHubLink")
def send_to_gitub():
    """
    makes a new tab for user to my github link
    :return: none
    """
    webbrowser.open_new_tab('https://github.com/Bodil74')


@view.route("/snake")
def load_snake():
    """
    loads the snake page and runs snake.py
    :return: none 
    """
    return render_template("snake.html")


@view.route("/randomWalker")
def load_random_walker():
    """
    loads the random walker and runs randomwalker.py
    :return: none
    """
    return render_template("randomWalker.html")


@view.route("/flappyBirdAI")
def load_flappyBirdAI():
    """
    loads the flappy bird ai page and runs flappyBirdAI.py
    :return: none
    """
    return render_template("flappyBirdAI.html")
'''
